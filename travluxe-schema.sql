...
CREATE TABLE city (
    ...
    time INTEGER,
    user_username VARCHAR REFERENCE users(username) ON DELETE CASCADE
);
...
INSERT INTO city (name, country, timezone, time, user_username)
VALUES ('Paris', 'France', 'Europe/Paris', 7200, 'johndoe'),
       ('Barcelona', 'Spain', 'Europe/Madrid', 7200, 'janedoe');

-- Insert sample weather data
INSERT INTO weather (temperature, conditions, wind_speed, user_username, city_id)
VALUES (23.5, 'Sunny', 15.6, 'johndoe', 1),
       (17.8, 'Cloudy', 8.3, 'janedoe', 2);

-- Insert sample restaurants
INSERT INTO restaurants (name, rating, address, phone, image_url, user_username, city_id)
VALUES ('Chez Pierre', 4.5, '12 Rue de la Paix, 75002 Paris', '+33 1 42 61 68 29', 'https://example.com/chez-pierre.jpg', 'johndoe', 1),
       ('El Xampanyet', 4.3, 'Carrer de Montcada, 22, 08003 Barcelona', '+34 933 19 30 33', 'https://example.com/el-xampanyet.jpg', 'janedoe', 2);

-- Insert sample touristic sites
INSERT INTO touristic_sites (name, website, rating, address, phone, image_url, city_id)
